"""Page: Agent — Empfehlungen.

Lifted from Tab 5 of app.py during Phase 3.  History sections
(decision log, persisted runs, Critic/Lern-Loop) were split into
``agent_history.py`` during Phase 7.
"""
